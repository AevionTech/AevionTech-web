...
const OrchardSection = () => {
  return (
    <section id="orchard" className="relative py-24 lg:py-32 bg-secondary scroll-mt-16">
      {/* Subtle grid pattern */}
      <div 
        ...
        <div className="max-w-4xl">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-lg">
              A new paradigm in online dating. Genuine connections powered by intelligent matching.
            </p>
            ...
            <div className="pt-8 border-t border-border">
              <div className="grid grid-cols-3 gap-8">
                ...
                <div>
                  <div className="font-mono text-2xl font-bold text-foreground">iOS</div>
                  <div className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest mt-1">
                    First
                  </div>
                </div>
